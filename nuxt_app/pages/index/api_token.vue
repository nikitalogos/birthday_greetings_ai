  ...
  <div class="api-token-wrapper">
    ...
    <form>
      <div class="param">
        ...
        <button v-if="is_token_visible" class="show-token" aria-label="Hide token" @click="is_token_visible = false">
          <i class="white eye icon"></i>
        </button>
        <button v-else class="show-token" aria-label="Hide token" @click="is_token_visible = true">
