        ...
        event: {
          field: {
            ...
            change: function (event) {
              ...
              if (
                validationRules &&
                (settings.on == "change" || ($fieldGroup.hasClass(className.error) && settings.revalidate))
              ) {
      ...
      module = {
          ...
          menu: {
            mutation: function (mutations) {
              var mutation = mutations[0],
                ...
                isUserAddition =
                  $changedNodes.is(selector.addition) || $changedNodes.closest(selector.addition).length > 0,
        ...
        get: {
          ...
          item: function (value, strict) {
            var $selectedItem = false,
              ...
              isMultiple;
            value =
              value !== undefined ? value : module.get.values() !== undefined ? module.get.values() : module.get.text();
        ...
        scrollPage: function (direction, $selectedItem) {
          var $currentItem = $selectedItem || module.get.selectedItem(),
            ...
            newScroll =
              direction == "up" ? currentScroll - itemHeight * itemsPerPage : currentScroll + itemHeight * itemsPerPage,
        ...
        has: {
          ...
          label: function (value) {
            ...
            return (
              $labels.filter("[data-" + metadata.value + '="' + module.escape.string(escapedValue) + '"]').length > 0
            );
          },
        ...
        can: {
          ...
          openDownward: function ($subMenu) {
            ...
            onScreen = {
              above:
                ...
                calculations.menu.offset.top - calculations.context.offset.top - calculations.menu.height,
              below:
          ...
          openRightward: function ($subMenu) {
            ...
            isOffscreenRight =
              calculations.menu.offset.left - calculations.context.offset.left + calculations.menu.width >=
      ...
      module = {
        ...
        generate: {
          ...
          parameters: function (source, extraParameters) {
            var parameters =
              sources[source] && sources[source].parameters !== undefined ? sources[source].parameters(settings) : {};
          ...
          dimmerSettings: function () {
            ...
            if (settings.inverted) {
              dimmerSettings.variation =
                dimmerSettings.variation !== undefined ? dimmerSettings.variation + " inverted" : "inverted";
            }
        ...
        activate: {
          ...
          navigation: function (tabPath) {
            var $navigation = module.get.navElement(tabPath),
              $deactiveNavigation =
                settings.deactivate == "siblings" ? $navigation.siblings($allModules) : $allModules.not($navigation),
