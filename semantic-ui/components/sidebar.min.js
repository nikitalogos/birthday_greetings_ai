      ...
      return (
        e.each(function () {
          var s,
            ...
            i,
            l,
            c = D.isPlainObject(C) ? D.extend(!0, {}, D.fn.sidebar.settings, C) : D.extend({}, D.fn.sidebar.settings),
            n = c.selector,
            r = c.className,
            t = c.namespace,
            o = c.regExp,
            ...
            y = {
              ...
              bind: {
                clickaway: function () {
                  y.verbose("Adding clickaway events to context", h),
                    c.closable && h.on("click" + a, y.event.clickaway).on("touchend" + a, y.event.clickaway);
                },
                scrollLock: function () {
                  c.scrollLock && (y.debug("Disabling page scroll"), w.on("DOMMouseScroll" + a, y.event.scroll)),
              ...
              unbind: {
                ...
                scrollLock: function () {
                  y.verbose("Removing scroll lock from page"), T.off(a), w.off(a), b.off("scroll" + u);
                },
              },
              add: {
                inlineCSS: function () {
              ...
              setup: {
                cache: function () {
                  y.cache = { width: b.outerWidth(), height: b.outerHeight(), rtl: "rtl" == b.css("direction") };
                },
                layout: function () {
              ...
              pushPage: function (i) {
                ...
                (i = D.isFunction(i) ? i : function () {}),
                  ...
                  (t = function (e) {
                    e.target == r[0] && (r.off(l + a, t), y.remove.animating(), y.bind.scrollLock(), i.call(v));
                  }),
                  r.off(l + a),
                  r.on(l + a, t),
                  M(e),
              ...
              performance: {
                log: function (e) {
                  ...
                  c.performance &&
                    ...
                    (F = i),
                    O.push({ Name: e[0], Arguments: [].slice.call(e, 1) || "", Element: v, "Execution Time": n })),
