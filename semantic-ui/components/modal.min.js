            ...
            S = {
                ...
                dimmer: function () {
                  ...
                  j.fn.dimmer !== N
                    ? (S.debug("Creating dimmer"),
                      (o = v.dimmer(n)),
                      c.detachable
                        ? (S.verbose("Modal is detachable, moving content into dimmer"), o.dimmer("add content", h))
                        : S.set.undetached(),
              ...
              attachEvents: function (e, n) {
                ...
                (n = j.isFunction(S[n]) ? S[n] : S.toggle),
                  0 < i.length
                    ? (S.debug("Attaching modal events to element", e, n), i.off(f).on("click" + f, n))
                ...
                (e = j.isFunction(e) ? e : function () {}),
                  S.is.animating() || !S.is.active()
                    ? (S.showDimmer(),
                      ...
                      S.can.useFlex()
                        ? S.remove.legacy()
                        : (S.set.legacy(), S.set.modalOffset(), S.debug("Using non-flex legacy modal positioning.")),
                      S.set.screenHeight(),
                      S.set.type(),
                      S.set.clickaway(),
              ...
              hideAll: function (e) {
                ...
                (e = j.isFunction(e) ? e : function () {}),
                  0 < n.length && (S.debug("Hiding all visible modals"), S.hideDimmer(), n.modal("hide modal", e));
              },
                ...
                dimmerSettings: function () {
                  ...
                  j.fn.dimmer !== N
                    ? ((e = {
                      ...
                      (n = j.extend(!0, e, c.dimmerSettings)),
                      c.inverted && (n.variation = n.variation !== N ? n.variation + " inverted" : "inverted"),
                      v.dimmer("setting", n))
                    : S.error(m.dimmer);
                },
                dimmerStyles: function () {
              ...
              debug: function () {
                !c.silent &&
                  ...
                  (c.performance
                    ...
                    : ((S.debug = Function.prototype.bind.call(console.info, console, c.name + ":")),
              ...
              verbose: function () {
                !c.silent &&
                  ...
                  (c.performance
                    ? S.performance.log(arguments)
                    : ((S.verbose = Function.prototype.bind.call(console.info, console, c.name + ":")),
              ...
              performance: {
                log: function (e) {
                  ...
                  c.performance &&
                    ...
                    (A = n),
                    O.push({ Name: e[0], Arguments: [].slice.call(e, 1) || "", Element: p, "Execution Time": i })),
